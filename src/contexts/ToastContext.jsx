        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className="pointer-events-auto card p-4 flex items-center gap-3 w-80 relative overflow-hidden shadow-2xl"
            >
              {/* Glass subtle gradient */}
              <div className="absolute inset-0 bg-gradient-to-r from-white/[0.02] to-transparent pointer-events-none" />
              
              <div className="shrink-0 p-1.5 rounded-full bg-white dark:bg-[#2A2A2A] border border-[var(--border)] shadow-sm">
              ...
              <button
                ...
                className="text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] transition-colors shrink-0 p-1 rounded-md hover:bg-black/5 dark:hover:bg-white/5"
              >
                <X size={16} />
              </button>
            </motion.div>
