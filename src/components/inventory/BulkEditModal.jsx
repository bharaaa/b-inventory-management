      ...
      {isOpen && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-white/10 backdrop-blur-xl border border-[var(--border)] rounded-2xl shadow-xl"
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--border)] bg-[rgba(255,255,255,0.05)] backdrop-blur-sm rounded-t-2xl">
                  ...
                  <AnimatePresence>
                    {openCategory && (
                      <motion.div
                        ...
                        className="absolute left-0 mt-2 w-full bg-white/10 backdrop-blur-md border border-[var(--border)] rounded-xl shadow-sm z-50 py-1.5 overflow-hidden max-h-48 overflow-y-auto"
                      >
                        <button
                          type="button"
                          onClick={() => {
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm bg-[rgba(255,255,255,0.03)] backdrop-blur-sm border border-[var(--border)] rounded-lg text-[var(--text-primary)] focus:outline-none focus:border-[var(--accent)] transition-all placeholder:text-[var(--text-tertiary)]"
