            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5 rounded-b-2xl">
              ...
              <div className="pt-2 flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-[var(--accent-fg)] bg-[var(--accent)] rounded-xl hover:bg-[var(--accent-hover)] shadow-[0_4px_14px_var(--accent-subtle)] transition-colors disabled:opacity-70 cursor-pointer"
                >
