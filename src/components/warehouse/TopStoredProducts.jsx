  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full mt-5 flex items-center justify-center gap-2 py-2 text-xs font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-secondary)] rounded-lg transition-colors cursor-pointer"
      >
        View All Inventory
        <ArrowRight size={14} />
      </button>
